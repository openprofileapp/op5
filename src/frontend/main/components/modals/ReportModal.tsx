...
export default function ReportModal() {
    ...
    function closeReportModal() {
        (document.getElementById("report") as HTMLDialogElement)?.close();
            ...
            <div className="modal-box max-w-235">
                ...
                <div className="flex flex-row gap-6">
                    <div className="tabs tabs-lift flex w-full">
                        <input type="radio" name="report-tabs" className="md:hidden tab bg-base-200 flex-1" aria-label="General" checked={activeTab === "general"} onChange={() => setActiveTab("general")}/>
                        ...
                        <input type="radio" name="report-tabs" className="md:hidden tab bg-base-200 flex-1" aria-label="Preview" checked={activeTab === "preview"} onChange={() => setActiveTab("preview")}/>
