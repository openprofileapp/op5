...
OutputDir=release
OutputBaseFilename=OpenProfile_5.1.0-beta-build-e1ffd75_Installer_Windows
Compression=lzma
...
VersionInfoTextVersion=5.1.0-beta-build-e1ffd75
VersionInfoProductVersion=5.1.0
VersionInfoCompany=OpenProfile
VersionInfoDescription=OpenProfile is a free original character database and collaboration platform made by and for writers.
